...
public class ConditionedTriangleStat implements Statistic {
		...
		private Direction m_condDir3;
		private String m_attr1;
		private String m_attr2;
		private String m_condAttr3;
		...
		public ConditionedTriangleStat(Direction dir1, String attr1, Direction dir2, String attr2, Direction condDir3, String condAttr3) {
			m_dir1 = dir1;
			m_dir2 = dir2;
			m_condDir3 = condDir3;
			m_attr1 = attr1;
			m_attr2 = attr2;
			m_condAttr3 = condAttr3;
		}
		...
		public String getName() {
			...
			res += m_condDir3.toString() + " " + m_condAttr3 + "])";
			return res;
		}
		...
		private void updateDegreeStats(double currentTime, EventNetwork g) {
			...
			//conditioning matrix
			DenseMatrix64F edgeCondMatrix3 = g.getEdgeMatrix(m_condAttr3, currentTime);
			...
			if( m_condDir3 == Direction.OUT ) {
				CommonOps.transpose(edgeCondMatrix3);
			}
			...
			if( m_condDir3 == Direction.SYM ) {
				DenseMatrix64F edgeCondMatrix3T = edgeCondMatrix3.copy();
				CommonOps.transpose(edgeCondMatrix3T);
				CommonOps.addEquals(edgeCondMatrix3, edgeCondMatrix3T);
			}
			...
			//now condtion
			CommonOps.elementMult(m_degreeStats, edgeCondMatrix3);
